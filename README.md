...
From there you can register a nickname and username, join channels, and send messages as you would on any IRC server.
...
- The IRC protocol RFCs (**RFC 1459** and **RFC 2812**) for command syntax, numeric replies, and expected server behavior.
...
Overall, our use of AI was minimal. **The code itself was not generated by AI** — it was written, reviewed, and understood by the team.